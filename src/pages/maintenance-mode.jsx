const Maintenance = () => {
  return (
    <div className="maintenance flex justify-center h-screen items-center">
      <div className="wrapper text-center">
        <div className="image flex justify-center">
          <img src="src/assets/images/cmc-addmission-logo.png" alt="cmc logo" />
        </div>
        <div className="flex justify-center mb-9 h-[399px] w-[583px]">
          <img
            src="src/assets/images/maintenance-image.png"
            alt=""
