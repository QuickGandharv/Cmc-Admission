    ...
    <form action="" className={`w-full bg-white-default`}>
      ...
      <div className="flex gap-10">
        <div className="w-full mt-0">
          <Inputfield label="Name of Applicant" labelclass="font-medium" />
        </div>
        <div className="w-full mt-0">
          <Inputfield label="BFUHS Registration Id" labelclass="font-medium" />
        </div>
        <div className="w-full mt-0">
          <Inputfield label="NEET pg 2024 Roll No." labelclass="font-medium" />
        </div>
      </div>
      <div className="flex gap-10">
