...
const Login = () => {
  ...
  useEffect(() => {
    if (data) {
      const {
        token,
        user: { role, permissions_list: permissions },
      } = data;
      setUserData({ token, role, permissions });
      navigate("/");
    }
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="py-10 px-[30px] text-black-default">
              ...
              <div className="relative">
                ...
                >
                  {showPassword ? (
                    <AiOutlineEye color="#4D4D4D" size={20} />
                  ) : (
                    <AiOutlineEyeInvisible color="#4D4D4D" size={20} />
                  )}
                </span>
              </div>
              ...
              <Button
                ...
                text={loading ? "Loading in..." : "Submit"}
                disabled={loading}
              />
