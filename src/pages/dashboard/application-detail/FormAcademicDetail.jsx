...
import GraduateOfCmc from "./application-detail-components/GraduateOfCmc";
import PeriodOfService from "./application-detail-components/PeriodOfService";
import NeetPgDetails from "./application-detail-components/NeetPgDetails";
import GraduateOfOther from "./application-detail-components/GraduateOfOther";
import { useForm } from "react-hook-form";

const FormAcademicDetail = () => {
  const {
    control,
    handleSubmit,
    formState: { errors },
...
export default FormAcademicDetail;
